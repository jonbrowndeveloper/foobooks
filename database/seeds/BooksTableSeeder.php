...
class BooksTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($books as $key => $thisBook) {
            ...
            $book->title = $thisBook[0];
            $book->author = $thisBook[1];
            $book->published_year = $thisBook[2];
            $book->cover_url = $thisBook[3];
            $book->purchase_url = $thisBook[4];
